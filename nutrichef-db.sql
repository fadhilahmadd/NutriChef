...
CREATE TABLE `menu_user` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `penyakit_id` (`menu_id`),
  CONSTRAINT `menu_user_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `menu_user_ibfk_2` FOREIGN KEY (`menu_id`) REFERENCES `menu` (`id`)
...
-- Dump completed on 2024-09-27 18:44:14
